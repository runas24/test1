...
document.getElementById("loanForm").addEventListener("submit", function(event) {
    ...
    var loadingMessage = document.querySelector('.result-container .loading-message');
    ...
    setTimeout(function() {
        ...
        document.querySelector('.result-container #maxLoanAmount').innerText = "Максимальная сумма кредита: " + maxLoanAmount.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, " ") + " тенге";
